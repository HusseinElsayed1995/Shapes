 ...
 * @author hussein_pc
 */
public class Bresenham_code extends JPanel implements ActionListener {
    ...
    Bre_table object3 = new Bre_table();
    Draw_Bresenham ob = new Draw_Bresenham();
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        object3.setBounds(290, 20, 300, 630);
        d.add(object3);
    }

    public void draw() {

        int xi = (int) Float.parseFloat(Xi.getText().trim());
        int xf = (int) Float.parseFloat(Xf.getText().trim());
        int yi = (int) Float.parseFloat(Yi.getText().trim());
        int yf = (int) Float.parseFloat(Yf.getText().trim());
        object3.cre_tabel(xi, yi, xf, yf);
        ob.Draw(xi, yi, xf, yf);
    ...
    public void translate() {
        ...
        ob.Draw((int) Float.parseFloat(Xi.getText().trim()) + xtr, (int) Float.parseFloat(Yi.getText().trim()) + xtr, (int) Float.parseFloat(Xf.getText().trim()) + ytr, (int) Float.parseFloat(Yf.getText().trim()) + ytr);
    }
    ...
    public void scale() {
        ...
        ob.Draw((int) Float.parseFloat(Xi.getText()) * xs, (int) Float.parseFloat(Yi.getText()) * xs, (int) Float.parseFloat(Xf.getText()) * ys, (int) Float.parseFloat(Yf.getText()) * ys);
    }
      public void rotat(){
      ...
      float x1, y1,val1,val2,s;
        ...
        ob.Draw((int)Float.parseFloat(Xi.getText()),(int)Float.parseFloat(Yi.getText()), (int)val1, (int)val2);
    ...
    public void cliping() {
        ...
        ob.Draw((int) xn1, (int) yn1, (int) xn2, (int) yn2);
    }
